...
const Banner = ({ day, title, text, credit, fullday, tags }: BannerProps) => {
  return (
    <div className="w-[43.75rem] h-[11.27rem] bg-[#F4C94A] flex justify-around items-center rounded-3xl border-solid border-2 border-black">
      ...
      <div className="w-[31.63rem] ">
        <h1 className="text-[2.59rem] font-bold">{title}</h1>
